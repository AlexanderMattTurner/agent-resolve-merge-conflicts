...
jobs:
  resolve:
    ...
    permissions:
      ...
      pull-requests: write
      statuses: write
    uses: AlexanderMattTurner/agent-resolve-merge-conflicts/.github/workflows/auto-resolve.yaml@652d34fff5f1d729f95615be8bbffdd0aa841c31 # v1.17.2
    with:
      pr: ${{ matrix.pr.number }}
