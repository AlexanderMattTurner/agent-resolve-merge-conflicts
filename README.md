...
jobs:
  resolve:
    ...
    permissions:
      ...
      pull-requests: write
      statuses: write
    uses: AlexanderMattTurner/agent-resolve-merge-conflicts/.github/workflows/auto-resolve.yaml@6e8ef6110fd27a4402a964d4c65c596a0ce7e938 # v1.13.5
    with:
      pr: ${{ matrix.pr.number }}
