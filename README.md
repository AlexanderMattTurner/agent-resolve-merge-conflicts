...
- **`self-review`** — the pre-push merge-delta self-review is opt-in. Pass `self-review: true` when no CI of yours reads the pushed delta and gates the merge on the finding. The resolver otherwise pushes merges nothing will ever review.
