...
_LADDER = ".github/resolver/lib-ci-retry.sh"


def _delay_seconds(milliseconds: str) -> subprocess.CompletedProcess[str]:
...
def test_a_millisecond_knob_converts_to_whole_seconds(
    milliseconds: str, seconds: str
) -> None:
    done = _delay_seconds(milliseconds)
