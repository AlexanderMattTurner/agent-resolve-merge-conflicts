"""Behavior tests for .github/resolver/claude-run-errored.sh — the retry-decision
...
# covers: .github/resolver/claude-run-errored.sh
"""
...
SCRIPT = REPO_ROOT / ".github" / "resolver" / "claude-run-errored.sh"
