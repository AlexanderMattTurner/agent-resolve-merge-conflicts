"""`docs/tla/ConflictLedger.tla` is what the emitter prints right now.
...
from tests import _ledger_fsm_tla as emitter
...
def test_every_transition_the_model_compiles_is_emitted_as_an_action():
    ...
    for spec in emitter.ledger.LEDGER_TRANSITIONS:
